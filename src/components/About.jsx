...
const About = () => {
    return (
        ...
        <div className="justify-center px-10 py-10 text-justify text-[#b5bcbf]  md:w-[800px] md:flex md:gap-8">
            ...
            <h1 className="flex gap-2 py-2 text-2xl font-bold"><BsPerson color="#e8b025" className="mt-1"/> About Me </h1>
                ...
                and i enjoy building things
                    ...
                    on paper, well i could not afford a computer but was still fun 😂 for me then
                    . However, i started the journey of being a software developer 2020 during the 
                    pademic, 
                </p>
                <p>
