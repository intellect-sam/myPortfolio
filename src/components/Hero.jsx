...
const Hero = () => {
  ...
  return (
    <section className={`flex flex-col-reverse justify-center px-10 md:gap-5 md:flex-row md:mx-20 md:flex md:px-96 ${styles.textWhite}`} >
      ...
      <div className="justify-center w-full pt-[100px] text-center md:mt-0 md:text-left">
