    ...
    >
      ...
      <div className="justify-center text-center md:mt-0 md:text-left">
        ...
        <p className="py-4 my-3 md:text-xl font-light text-justify text-[#b5bcbf] md:text-justify md:w-2/3">
          ...
          specializing in crafting exceptional digital experiences. With a keen eye for design, I
          not only build but also contribute to the aesthetic aspects of the products I work on 👨‍💻
        </p>
